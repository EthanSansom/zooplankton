...
if FREEZE_BACKBONE:
    CONFIG_FILE = "lcpn_flat_backbone_frozen_2026_03_23.toml"
    MODEL_NAME = "lcpn_flat_backbone_frozen"
else:
    CONFIG_FILE = "lcpn_flat_backbone_unfrozen_2026_03_23.toml"
    MODEL_NAME = "lcpn_flat_backbone_unfrozen"
